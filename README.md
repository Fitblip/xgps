...
If [available in Hex](https://hex.pm/docs/publish), the package can be installed as:
  ...
  3. To make an effort to be platform independent, XGPS uses [circuits_uart](https://github.com/elixir-circuits/circuits_uart) for the dirty details. Please make sure to follow the instructions for circuits_uart (formerly known as nerves_uart) to make this compile and run on your system.
